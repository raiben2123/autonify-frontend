...
import { VisibleItemsPipe } from '../../shared/pipes/visible-items.pipe';
import { PermissionService } from '../../core/auth/permission.service';
import { NavItem, NavGroup } from './sidebar.model';
...
const ICONS = {
    ...
    landmark: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="22" x2="21" y2="22"/><line x1="6" y1="18" x2="6" y2="11"/><line x1="10" y1="18" x2="10" y2="11"/><line x1="14" y1="18" x2="14" y2="11"/><line x1="18" y1="18" x2="18" y2="11"/><polygon points="12 2 20 7 4 7"/></svg>`,
    ...
    chevronsLeft: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="11 17 6 12 11 7"/><polyline points="18 17 13 12 18 7"/></svg>`,
    chevronsRight: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="13 17 18 12 13 7"/><polyline points="6 17 11 12 6 7"/></svg>`,
};

@Component({
    selector: 'app-sidebar',
    standalone: true,
    imports: [CommonModule, RouterLink, RouterLinkActive, RouterOutlet, SafeHtmlPipe, VisibleItemsPipe, RoleLabelPipe],
    ...
    readonly nav: NavGroup[] = [
        {
            label: 'Principal',
            items: [
                { label: 'Inicio',     route: '/inicio',     icon: ICONS.home,        module: 'inicio' },
                { label: 'Clientes',   route: '/clientes',    icon: ICONS.users,       module: 'clients' },
                { label: 'Proyectos',  route: '/proyectos',   icon: ICONS.folder,      module: 'projects' },
                { label: 'Tareas',     route: '/tareas',      icon: ICONS.checkSquare, module: 'tasks' },
                { label: 'Tiempo',     route: '/tiempo',      icon: ICONS.clock,       module: 'time' },
            ],
        },
        {
            label: 'Facturación',
            items: [
                { label: 'Facturas',     route: '/facturas',     icon: ICONS.fileText,  module: 'invoices' },
                { label: 'Presupuestos', route: '/presupuestos', icon: ICONS.filePlus,  module: 'quotes' },
                { label: 'Gastos',       route: '/gastos',       icon: ICONS.creditCard, module: 'expenses' },
                { label: 'Proveedores',  route: '/proveedores',  icon: ICONS.truck,     module: 'suppliers' },
                { label: 'Catálogo',     route: '/catalogo',     icon: ICONS.grid,      module: 'catalog' },
            ],
        },
        {
            label: 'Fiscalidad',
            items: [
                { label: 'Fiscal', route: '/fiscal', icon: ICONS.landmark, module: 'fiscal' },
            ],
        },
    ];
}